...
import net.meshkorea.platform.core.web.repository.GenericRepository;

/**
 * Created by yjhan on 2017. 3. 17..
 */
@MasterDbConfig.MasterData
public interface ClaimHistoryRepository extends GenericRepository<ClaimHistory, Long> {
}
